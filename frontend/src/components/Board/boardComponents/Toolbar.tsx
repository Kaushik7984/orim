...
const Toolbar = ({
  ...
  return (
    <motion.div className='flex flex-col  items-center mt-12 ml-2 md:mt-14'>
      <div
        className='flex flex-col rounded-md bg-white border border-gray-200 items-center shadow-md'
      ...
      <div
        className='mt-4 flex flex-col items-center rounded-md bg-white border border-gray-200 shadow-md'
        style={{ boxShadow: "1px 1px 5px rgba(0, 0, 0, 0.3)" }}
      >
