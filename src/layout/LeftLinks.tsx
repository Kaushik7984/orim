  ...
  return (
    <div className='lg:flex hidden flex-row items-center gap-1'>
      {leftlinks.map((l) => (
        <div
          key={l.name}
          className='flex flex-row items-center gap-[0.5px] font-extralight capitalize text-sm cursor-pointer p-2 rounded-lg hover:bg-neutral-200 hover:underline duration-200'
        >
          <span>{l.name}</span>
